...
public:
	...
	char* getAirportID() const;
	//Precondition:  None.
	//Postcondition:  Returns the airport's identifier.

	char* getAirportName() const;
	//Precondition:  None.
	//Postcondition:  Returns the airport's name.

	
	char* getRunwayNumber() const;
	//Precondition:  None.
	//Postcondition:  Returns the airport's runway number.

	int getRunwayLength() const;
	//Precondition:  None.
	//Postcondition:  Returns the airport's runway length.


	virtual ostream& print(ostream&) const;
	//Precondition:  Intakes an instance of the ostream reference.
	//Postcondition:  Calls the overloaded output operators for the derived classes.
